<div>
                ...
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 rounded-lg md:space-x-2 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0 bg-transparent">
                    <li>
                        <a href="{{ route('landing-page') }}" class="relative block py-2 px-2 md:px-4 text-white rounded-md overflow-hidden group">
                            <span class="absolute inset-0 bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                            <span class="relative z-10 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:via-blue-500 group-hover:to-indigo-600">Beranda</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('landing-page') }}#AboutSection" class="relative block py-2 px-2 text-white rounded-md overflow-hidden group">
                            <span class="absolute inset-0 bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                            <span class="relative z-10 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:via-blue-500 group-hover:to-indigo-600">Tentang</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('user.project') }}" class="relative block py-2 px-2 text-white rounded-md overflow-hidden group">
                            <span class="absolute inset-0 bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                            <span class="relative z-10 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:via-blue-500 group-hover:to-indigo-600">Projek</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('user.experience') }}" class="relative block py-2 px-2 text-white rounded-md overflow-hidden group">
                            <span class="absolute inset-0 bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                            <span class="relative z-10 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:via-blue-500 group-hover:to-indigo-600">Pengalaman</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('user.sertifikat') }}" class="relative block py-2 px-2 text-white rounded-md overflow-hidden group">
                            <span class="absolute inset-0 bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                            <span class="relative z-10 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:via-blue-500 group-hover:to-indigo-600">Sertifikat</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('landing-page') }}#ContactSection" class="relative block py-2 px-2 text-white rounded-md overflow-hidden group">
                            <span class="absolute inset-0 bg-gradient-to-r from-purple-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                            <span class="relative z-10 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:via-blue-500 group-hover:to-indigo-600">Kontak</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <script>
        ...
        // Tutup menu kalau layar diperbesar ke lg
