<div>
    <div class="fixed inset-0 bg-black/60 z-[9999] flex items-center justify-center p-4" wire:show="show" x-cloak>
        <div  class="bg-[#0b0b14] text-white w-full max-w-xl rounded-xl relative max-h-[85vh] overflow-y-auto translate-y-1">
            <div class="grid grid-cols-12 p-5">
                ...
                <div class="col-span-12 grid grid-cols-1 gap-5 mb-5">
                    ...
                    <x-component.input.var1 label="CV" type="file" placeholder="Masukkan file" model="CV" readonly="0"/>
                    <x-component.input.var1 label="Deskripsi tentang" type="text" placeholder="Masukkan text" model="tentang" readonly="0"/>
                    <livewire:component.input.var1 :tags="$skill" wire:key="tags-{{ now()->timestamp }}"/>
                </div>
                <div class="col-span-12 grid grid-cols-1 gap-5 mb-5">
                    <x-component.button.var1 label="Update Landing Data" wire:click="save" />
                    <button wire:click="hide" class="text-sm font-medium mx-2 md:mx-0 py-[8px] px-10 text-white text-red-600  rounded-full shadow-lg border-2 border-red-600 hover:bg-red-600  hover:text-white hover:shadow-[0_0_20px_rgba(130,90,250,0.4)]">
                        Close
                    </button> 
                </div>        
            </div>
