        ...
        <div class="w-full max-w-sm mx-auto p-10 rounded-xl bg-white/5 backdrop-blur-xl">
            ...
            <form>
                <div class="mb-5 relative">
                    <livewire:component.field-input-var1 label="Email" type="email" placeholder="Masukkan email"/>
                ...
                <div class="relative">
                    <livewire:component.field-input-var1 label="Password" type="password" placeholder="Masukkan password"/>
                </div>
                <div class="flex mt-2">
