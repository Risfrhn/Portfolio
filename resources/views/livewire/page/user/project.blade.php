<div class="container mx-auto max-w-screen-xl px-5 xl:px-0 min-h-screen pt-32 pb-20">
    ...
    <div class="text-center mb-12">
        <div class="inline-block px-4 py-1.5 mb-4 rounded-full border border-purple-500/30 bg-purple-900/20 backdrop-blur-md">
            <span class="text-purple-300 font-bold tracking-[0.2em] text-[10px] md:text-xs uppercase">Portfolio</span>
        </div>
        ...
        <p class="text-gray-400 text-sm md:text-base font-light max-w-2xl mx-auto">
            Jelajahi koleksi proyek unggulan dan produk digital yang telah saya kembangkan.
        </p>
    </div>
    ...
    <div class="mb-12 space-y-4">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <!-- Category Filter -->
            <div class="relative">
                <select wire:model.live="filterCategory" class="appearance-none bg-[#150b2e] border border-white/10 text-gray-300 py-2 pl-4 pr-10 rounded-full text-sm focus:outline-none focus:border-purple-500 cursor-pointer hover:bg-white/5 transition-colors">
    ...
    <!-- Pagination -->
    <div class="mt-12">
        {{ $dataProject->links('livewire.component.pagination.custom') }}
    </div>
</div>
